...
pub enum MessageId {
    ...
    EvidenceOutputKept,
    EvidenceFailureOutputKept,
    EvidenceFailuresOutputKept,
    EvidenceDetailsUnavailable,
    EvidenceOpenDetails,
    EvidenceExactOutputHeader,
    EvidenceStoreRejected,
    EvidencePathUnsafe,
    EvidenceIntegrityFailed,
    EvidenceReadFailed,
    EvidenceRawOutput,
    EvidenceModelObservation,
    EvidenceResultOrdinal,
    EvidencePagerMultipleTitle,
    EvidenceUnknown,
    EvidenceRuntimeShell,
    EvidenceRuntimeMcp,
    EvidenceRuntimeTool,
    EvidenceProvenanceMissing,
    // Sidebar work strip.
    SidebarTasksLabel,
    SidebarTodoLabel,
    SidebarStopControl,
...
pub const ALL_MESSAGE_IDS: &[MessageId] = &[
    ...
    MessageId::EvidenceOutputKept,
    MessageId::EvidenceFailureOutputKept,
    MessageId::EvidenceFailuresOutputKept,
    MessageId::EvidenceDetailsUnavailable,
    MessageId::EvidenceOpenDetails,
    MessageId::EvidenceExactOutputHeader,
    MessageId::EvidenceStoreRejected,
    MessageId::EvidencePathUnsafe,
    MessageId::EvidenceIntegrityFailed,
    MessageId::EvidenceReadFailed,
    MessageId::EvidenceRawOutput,
    MessageId::EvidenceModelObservation,
    MessageId::EvidenceResultOrdinal,
    MessageId::EvidencePagerMultipleTitle,
    MessageId::EvidenceUnknown,
    MessageId::EvidenceRuntimeShell,
    MessageId::EvidenceRuntimeMcp,
    MessageId::EvidenceRuntimeTool,
    MessageId::EvidenceProvenanceMissing,
