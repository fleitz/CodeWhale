...
// Keep stream helpers in the parent namespace so existing `super::` paths compile.
use stream::{
    SSE_BACKPRESSURE_HIGH_WATERMARK, SSE_BACKPRESSURE_SLEEP_MS, SSE_MAX_LINES_PER_CHUNK,
    acquire_stream_buffer, extract_sse_data_value, release_stream_buffer, take_sse_line,
};
